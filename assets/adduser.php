...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt->execute()) {
        ...
        // Inserta desafíos por defecto para el nuevo usuario
        ...
        if ($stmt->execute()) {
            ...
            // Verifica los IDs de los desafíos
            echo "<pre>";
            print_r($challenge_ids); // Esto te ayudará a ver los IDs que estás obteniendo
            echo "</pre>";
